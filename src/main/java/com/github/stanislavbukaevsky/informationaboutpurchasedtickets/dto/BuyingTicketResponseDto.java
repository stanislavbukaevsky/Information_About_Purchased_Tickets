package com.github.stanislavbukaevsky.informationaboutpurchasedtickets.dto;
 ...
 * Этот объект приходит из топика Kafka из основного микросервиса
 */
@Data
@Schema(description = "Объект купленного транспортного билета пользователем для получения из топика Kafka")
